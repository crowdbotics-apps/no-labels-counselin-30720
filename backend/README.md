...
## Project Structure
    ...
    ├── no_labels_counselin_30720  # Django project configurations
...
1. Clone this repo and `cd no_labels_counselin_30720`
...
2. Clone this repo and `cd no_labels_counselin_30720`
